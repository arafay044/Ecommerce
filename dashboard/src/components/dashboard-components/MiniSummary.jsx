...
const MiniSummary = () => {
  ...
  let totalOrder = 0;
  totalOrder = Object.values(orderStatusCounts).reduce((acc, count) => acc + count, 0);
  ...
  const summary = [
    ...
    },
    {
      ...
      subText: `Total orders places: ${totalOrder}`,
  ...
  return <>
    <div className="bg-white rounded-xl p-6 shadow-md">
      ...
      <p className="text-sm text-gray-500 mb-4">Summary of key matrics for the current month</p>
