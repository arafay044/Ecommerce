...
const Payment = () => {
  ...
  if (!authUser) return naviagate("/products");

  const [stripePromise, setStripePromise] = useState(null);
  useEffect(() => {
    loadStripe(
      "pk_test_51SZNqHIQ8CyjckZioTsQwglJxr7fc1hYRt7gKB4zSzeXWYnIcOpxBGYnKGM5HKIQvdeIZC98ZshMYhpbPcIJGEVj00PSObsZKj",
    )
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4 ">
                      <div>
                        ...
                        >
                          ...
                          <option value="Azad Jamu & Kashmir (AJK)">
              ...
              <div className="lg:col-span-1">
                <div className="glass-panel stciky top-24">
