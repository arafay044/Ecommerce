...
const CartSidebar = () => {
  ...
  return (
    <>
      ...
      {/* CART SIDEBAR */}
      <div className="fixed right-0 top-0 h-full w-96 z-50 glass-panel animate-slide-in-right overflow-y-auto flex flex-col">
        <div className="flex items-center justify-between p-6 border-b bottom-[hsla(var(--glass-border))]">
