...
const AISearchModal = () => {
  ...
  const exampleText = [
    ...
    "A budget-friendly smartphone with a great camera",
    "A stylish backpack for college students",
    "A smartwatch with fitness tracking features",
    "A durable laptop for programming and gaming",
  ];
