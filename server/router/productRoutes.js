...
import { createProduct, deleteProduct, deleteProductReview, fetchAIFilteredProducts, fetchAllProducts, fetchSingleProduct, postProductReview, updateProduct } from '../controllers/productController.js'
...
router.delete('/delete/review/:productId', isAuthenticated, deleteProductReview);
